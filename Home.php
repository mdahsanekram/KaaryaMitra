        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <img src="image/KM2.jpg"  class="middleLogo" />
            ...
            <!-- Main Section start here -->
                <h1 class="text-center">Welcome to <span style="color: blue">Kaarya</span><span  style="color:red">Mitra</span> have a nice day...<br/><?php echo $_SESSION['username']; ?></h1>
